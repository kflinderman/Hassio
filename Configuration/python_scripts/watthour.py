...
lightbulbEntities = ['sensor.basement_floor_light_hours', 'sensor.washroom_light_hours', 'sensor.bedroom_fan_hours', 'sensor.bedroom_fan_hours', 'sensor.nursery_fan_hours', 'sensor.nursery_fan_hours', 'sensor.nursery_fan_hours', 'sensor.craft_room_fan_hours', 'sensor.craft_room_fan_hours', 'sensor.craft_room_fan_hours', 'sensor.master_bathroom_hours', 'sensor.master_bathroom_hours', 'sensor.master_bathroom_hours']
compEntities = ['sensor.computer_hours']
ledEntities = ['sensor.prep_area_hours', 'sensor.guest_bedroom_fan_hours', 'sensor.guest_bedroom_fan_hours', 'sensor.guest_bedroom_fan_hours', 'sensor.guest_bedroom_fan_hours', 'sensor.guest_bedroom_fan_hours', 'sensor.basement_hallway_light_hours', 'sensor.upstairs_hallway_light_hours']
