...
lightbulbEntities = ['sensor.sink_light_hours', 'sensor.basement_floor_light_hours', 'sensor.washroom_light_hours', 'sensor.bedroom_fan_hours', 'sensor.bedroom_fan_hours', 'sensor.nursery_fan_hours', 'sensor.nursery_fan_hours', 'sensor.nursery_fan_hours', 'sensor.craft_room_fan_hours', 'sensor.craft_room_fan_hours', 'sensor.craft_room_fan_hours', 'sensor.main_bathroom_hours', 'sensor.main_bathroom_hours', 'sensor.main_bathroom_hours']
compEntities = ['sensor.computer_hours']
ledEntities = ['sensor.kitchen_ceiling_light_hours', 'sensor.kitchen_ceiling_light_hours', 'sensor.kitchen_ceiling_light_hours', 'sensor.kitchen_ceiling_light_hours', 'sensor.kitchen_ceiling_light_hours', 'sensor.kitchen_ceiling_light_hours', 'sensor.cabinet_light_2_hours', 'sensor.cabinet_light_hours', 'sensor.cabinet_light_hours', 'sensor.cabinet_light_hours', 'sensor.guest_bedroom_fan_hours', 'sensor.guest_bedroom_fan_hours', 'sensor.guest_bedroom_fan_hours', 'sensor.guest_bedroom_fan_hours', 'sensor.guest_bedroom_fan_hours', 'sensor.basement_hallway_light_hours', 'sensor.upstairs_hallway_light_hours']
